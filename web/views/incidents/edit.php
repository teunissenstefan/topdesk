...
?>
<form action="?controller=incidents&action=edit&id=<?php echo $_GET['id']; ?>" method="POST">
<div class="row">
    ...
    <!--div class="form-group col-12">
        ...
        <input type="text" name="status" class="form-control" id="inputStatus" placeholder="Status" value="<?php echo $post_status;?>">
    </div-->
    <div class="form-group col-sm-12">
        <label for="inputStatus">Status</label>
